...
-- Generation Time: Feb 21, 2023 at 07:25 PM
...
--
-- Dumping data for table `cr_reunion`
--

INSERT INTO `cr_reunion` (`id_cr_reunion`, `nom`, `date_reunion`, `sujet`, `id_utilisateur`, `id_projet`) VALUES
(17, 'logo_avant.png', '2023-02-21', 'Test', 1, 135);
...
INSERT INTO `fichier` (`id_fichier`, `nom`, `date_ajout`, `id_utilisateur`, `id_repertoire`, `id_projet`) VALUES
(1, 'Note de frais 1', '2022-11-25', 1, NULL, 1),
(2, 'Note de frais 2', '2022-11-25', 1, NULL, 1),
(3, 'Note de frais 3', '2022-11-25', 1, 1, 1);
...
(134, 'test', '2023-02-21', '2023-02-10', 0, 1, 6),
(135, 'test3', '2023-02-21', '2023-02-24', 0, 1, 121);
...
INSERT INTO `repertoire` (`id_repertoire`, `nom`, `date_ajout`, `id_utilisateur`, `id_projet`, `id_repertoire_pere`) VALUES
(1, 'Dossier 1', '2022-11-01', 1, 1, NULL),
(2, 'Dossier 2', '2022-11-01', 1, 1, NULL),
(3, 'Sous-dossier 1', '2022-11-01', 1, 1, 1);
...
(44, 'dd', 'd', NULL, '2023-02-17', NULL, '2023-02-18', 2, 1, 34);
...
(3, 'ca41dd8b7e0a3e7d9aa7f8e689c48936d95d848d97febd6362c9cb60da275512', 'Angeli', 'Manon', '0618084480', 'manon', NULL, NULL, NULL, 1),
...
(116, '3468f484613a6149d9000ea6c1d8ab899177bb8f515a061450fc55f65f2c9d47', 'a', 'a', NULL, 'a', NULL, NULL, NULL, 1),
(117, '93254a349455c3ead8847f1c47aad2fa2c7190a1ad9d4ca3f28414f7a169820c', 'b', 'b', NULL, 'b', NULL, NULL, NULL, 1);
...
--
ALTER TABLE `cr_reunion`
  MODIFY `id_cr_reunion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `projet`
  MODIFY `id_projet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;
